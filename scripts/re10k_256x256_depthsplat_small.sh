...
output_dir=/root/autodl-tmp/re10k_outputs_20250127/checkpoints/re10k-depthsplat-small
...
# model.encoder.gaussian_regressor_channels=16 \
# model.encoder.feature_upsampler_channels=64 \
# checkpointing.pretrained_model=pretrained/depthsplat_model_zoo/depthsplat-gs-small-re10k-256x256-49b2d15c.pth \
# mode=test \
